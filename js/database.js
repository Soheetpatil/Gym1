// EliteFit Gym Database Management System
...
class EliteFitDB {
    ...
    async hashPassword(password) {
        ...
        const data = encoder.encode(password + 'EliteFitSalt2023'); // Add salt
    ...
    async createSession(userId) {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.onsuccess = () => {
                localStorage.setItem('eliteFitSession', sessionId);
    ...
    async logout(sessionId) {
        return new Promise((resolve, reject) => {
            ...
            request.onsuccess = () => {
                ...
                localStorage.removeItem('eliteFitSession');
...
const eliteFitDB = new EliteFitDB();

// Export for use in other files
window.EliteFitDB = eliteFitDB;